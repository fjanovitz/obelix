...
try:
    # Testar o Motor 1
    print("Motor 1 para frente (50% de velocidade)")
    motor1_forward(50)
    time.sleep(2)  # Rodar por 2 segundos
    stop_motors()
    time.sleep(1)

    print("Motor 1 para trás (75% de velocidade)")
    motor1_backward(100)
    time.sleep(2)
    stop_motors()
    time.sleep(1)
    ...
    # Testar o Motor 2
    print("Motor 2 para frente (50% de velocidade)")
    motor2_forward(25)
    time.sleep(2)
    stop_motors()
    time.sleep(1)

    print("Motor 2 para trás (75% de velocidade)")
    motor2_backward(75)
    time.sleep(2)
    stop_motors()
    time.sleep(1)
